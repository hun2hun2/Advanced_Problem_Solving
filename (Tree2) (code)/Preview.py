...
if __name__ == "__main__":
    ...
    print(findDivisorsSimple(100))
    print(f"Average running time for findDivisors(100000) is {timeit.timeit(lambda: findDivisors(100000), number=100)/100}")
    print(f"Average running time for findDivisorsSimple(100000) is {timeit.timeit(lambda: findDivisorsSimple(100000), number=100)/100}")
