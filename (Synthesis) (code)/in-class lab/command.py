...
class Expression:
    def __init__(self, expressionString=None, expressionId=None, expressionType=STRING):
        self.type = expressionType              # string (default), exp, ANDED, ORED
        self.size = 0                           # number of tokens underneath this node
        self.STR = expressionString
        self.EXP = expressionId
        self.AND = list()
        self.OR = list()
        self.OR_output_list = list()    # connect outputs that result from each selection
